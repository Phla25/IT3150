...
# Dữ liệu Confusion Matrix từ bước trên
# cm = np.array([[TN, FP], [FN, TP]])
# Ví dụ: cm = [[1, 1], [0, 2]] (1 True Negative, 1 False Positive, 0 False Negative, 2 True Positive)
import pandas as pd
import numpy as np
...
plt.title('Confusion Matrix cho Phân loại Spam')
